...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-obtained-a-grant-in-aid-for-early-career-scientists-若手研究",
          title: 'Obtained a Grant-in-Aid for Early-Career Scientists (若手研究)!',
          description: "",
          ...
          description: "",
          section: "News",},{id: "news-four-papers-accepted-to-ijcnlp-aacl-2025-three-main-one-demo",
          title: 'Four papers accepted to IJCNLP-AACL 2025 (three Main, one Demo)!',
          description: "",
          section: "News",},{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=IP5UyqcAAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
